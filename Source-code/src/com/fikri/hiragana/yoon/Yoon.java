...
public class Yoon extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Kya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Kyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Kyo.class.getName()));
