...
public class YoonR extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Rya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ryu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ryo.class.getName()));
