...
public class YoonN extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Nya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Nyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Nyo.class.getName()));
