...
public class YoonB extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Bya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Byu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Byo.class.getName()));
