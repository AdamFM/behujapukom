...
public class YoonG extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.gya);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.gyu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.gyo);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonG.this);
			...
			btnGy.setBackgroundColor(color);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Gya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Gyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Gyo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonG.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("GYA"));
	        YoonG.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("GYU"));
	        YoonG.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("GYO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonG activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
