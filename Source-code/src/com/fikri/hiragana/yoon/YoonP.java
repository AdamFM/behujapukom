...
public class YoonP extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Pya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Pyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Pyo.class.getName()));
