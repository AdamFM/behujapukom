...
public class YoonC extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Cha.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Chu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Cho.class.getName()));
