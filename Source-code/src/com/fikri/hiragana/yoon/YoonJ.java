...
public class YoonJ extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Jya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Jyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Jyo.class.getName()));
