...
public class YoonH extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.hya);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.hyu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.hyo);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonH.this);
			...
			btnHy.setBackgroundColor(color);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Hya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Hyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Hyo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonH.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("HYA"));
	        YoonH.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("HYU"));
	        YoonH.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("HYO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonH activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
