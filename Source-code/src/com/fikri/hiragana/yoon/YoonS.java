...
public class YoonS extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.sha);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.shu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.sho);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonS.this);
			...
			btnSh.setBackgroundColor(color);
			...
			btnky.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent k = new Intent().setClass(getApplicationContext(), Yoon.class);
			...
			btnPy.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent t = new Intent().setClass(getApplicationContext(), YoonP.class);
					startActivity(t);finish();
					overridePendingTransition  (R.animator.right_slide_out, R.animator.right_slide_in);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Sha.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Shu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Sho.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonS.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("SHA"));
	        YoonS.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("SHU"));
	        YoonS.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("SHO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonS activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
