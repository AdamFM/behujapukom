...
public class GojuonR extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		Button Vokal = (Button)findViewById(R.id.btnVokal);
		Vokal.setOnClickListener(new OnClickListener() {
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(this, Hira_Ra.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Ri.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Ru.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Re.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Ro.class.getName()));
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        GojuonR.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator("RA")); 
        GojuonR.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab2").setIndicator("RI")); 
        GojuonR.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab3").setIndicator("RU"));
        GojuonR.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab4").setIndicator("RE")); 
        GojuonR.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab5").setIndicator("RO")); 
     ...
     * @param args
     */
    private static void AddTab(GojuonR activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
