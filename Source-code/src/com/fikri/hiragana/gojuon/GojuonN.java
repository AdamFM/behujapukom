...
public class GojuonN extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPagerN() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Na.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ni.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Nu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ne.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_No.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_N.class.getName()));
