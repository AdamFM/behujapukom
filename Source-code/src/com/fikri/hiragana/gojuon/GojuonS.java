...
public class GojuonS extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPagerS() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Sa.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Shi.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Su.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Se.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_So.class.getName()));
	    ...
	    private void initialiseTabHostS(Bundle args) {
	    	...
	    	GojuonS.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("SA"), ( tabInfo = new TabInfo("Tab6", Hira_Ka.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonS.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("SHI"), ( tabInfo = new TabInfo("Tab7", Hira_Ki.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonS.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("SU"), ( tabInfo = new TabInfo("Tab8", Hira_Ku.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonS.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab9").setIndicator("SE"), ( tabInfo = new TabInfo("Tab9", Hira_Ke.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonS.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab10").setIndicator("SO"), ( tabInfo = new TabInfo("Tab10", Hira_Ko.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
