...
public class GojuonY extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(this, Hira_Ya.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Yu.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Yo.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Wa.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Wo.class.getName()));
