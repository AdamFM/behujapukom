...
public class GojuonM extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(this, Hira_Ma.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Mi.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Mu.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Me.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_Mo.class.getName()));
