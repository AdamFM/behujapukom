...
public class GojuonT extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  private TabHost mTabHost;
	  private ViewPager mViewPager;
	  private HashMap<String, TabInfo> mapTabInfo = new HashMap<String, GojuonT.TabInfo>();
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	        	...
	        	mediaPlayer = MediaPlayer.create(this, R.raw.ti);
	        }
	        else if (arg == 2) {
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(GojuonT.this);
	        ...
	        this.initialiseTabHostT(savedInstanceState);
	        if (savedInstanceState != null) {
	            mTabHost.setCurrentTabByTag(savedInstanceState.getString("tab")); //set the tab as per the saved state
	        }
	        // Intialise ViewPager
	        this.initialiseViewPagerT();        
	    }
	     ...
	     */
	    private void initialiseViewPagerT() {
	    	 List<Fragment> fragments = new Vector<Fragment>();
	       
	         fragments.add(Fragment.instantiate(this, Hira_Ta.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Chi.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Tu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Te.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_To.class.getName()));
	     ...
	     */
	    private void initialiseTabHostT(Bundle args) {
	    	mTabHost = (TabHost)findViewById(android.R.id.tabhost);
	        mTabHost.setup();
	        TabInfo tabInfo = null;
	        
	    	GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("TA"), ( tabInfo = new TabInfo("Tab6", Hira_Ka.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("CHI"), ( tabInfo = new TabInfo("Tab7", Hira_Ki.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("TSU"), ( tabInfo = new TabInfo("Tab8", Hira_Ku.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab9").setIndicator("TE"), ( tabInfo = new TabInfo("Tab9", Hira_Ke.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab10").setIndicator("TO"), ( tabInfo = new TabInfo("Tab10", Hira_Ko.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	     ...
	     * @param args
	     */
	    private static void AddTab(GojuonT activity, TabHost tabHost, TabHost.TabSpec tabSpec, TabInfo tabInfo) {
