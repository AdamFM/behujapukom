...
public class GojuonK extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPagerk() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Ka.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ki.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ku.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ke.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ko.class.getName()));
	    ...
	    private void initialiseTabHostK(Bundle args) {
	    	...
	    	GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("KA"), ( tabInfo = new TabInfo("Tab6", Hira_Ka.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("KI"), ( tabInfo = new TabInfo("Tab7", Hira_Ki.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("KU"), ( tabInfo = new TabInfo("Tab8", Hira_Ku.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab9").setIndicator("KE"), ( tabInfo = new TabInfo("Tab9", Hira_Ke.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab10").setIndicator("KO"), ( tabInfo = new TabInfo("Tab10", Hira_Ko.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
