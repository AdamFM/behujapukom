...
public class Gojuon extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(this, Hira_a.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_i.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_u.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_e.class.getName()));
        fragments.add(Fragment.instantiate(this, Hira_o.class.getName()));
