...
public class Dakuon extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	        	...
	        	mediaPlayer = MediaPlayer.create(this, R.raw.gi);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.gu);
	        }
	        else if (arg == 3) {
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(Dakuon.this);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Ga.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Gi.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Gu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ge.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Go.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	Dakuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("GA"));
	        Dakuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("GI"));
	        Dakuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("GU"));
	        Dakuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab9").setIndicator("GE"));
	        Dakuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab10").setIndicator("GO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(Dakuon activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
