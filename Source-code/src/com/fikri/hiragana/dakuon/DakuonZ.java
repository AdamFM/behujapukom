...
public class DakuonZ extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Za.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Zi.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Zu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Ze.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Zo.class.getName()));
