...
public class DakuonB extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(DakuonB.this);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Ba.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Bi.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Bu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Be.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Bo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	DakuonB.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator("BA"));
	        DakuonB.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab2").setIndicator("BI"));
	        DakuonB.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab3").setIndicator("BU"));
	        DakuonB.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab4").setIndicator("BE"));
	        DakuonB.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab5").setIndicator("BO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(DakuonB activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
