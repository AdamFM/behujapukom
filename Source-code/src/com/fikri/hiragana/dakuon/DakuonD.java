...
public class DakuonD extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	        	...
	        	mediaPlayer = MediaPlayer.create(this, R.raw.doh);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(DakuonD.this);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Hira_Da.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Di.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Du.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_De.class.getName()));
	         fragments.add(Fragment.instantiate(this, Hira_Do.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	DakuonD.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("DA"));
	        DakuonD.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("JI"));
	        DakuonD.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("ZU"));
	        DakuonD.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab9").setIndicator("DE"));
	        DakuonD.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab10").setIndicator("DO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(DakuonD activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
