...
public class DakuonD extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Da.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Di.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Du.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_De.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Do.class.getName()));
