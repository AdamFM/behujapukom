...
public class DakuonB extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Ba.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Bi.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Bu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Be.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Bo.class.getName()));
