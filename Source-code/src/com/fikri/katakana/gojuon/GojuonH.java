...
public class GojuonH extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(this, Kata_Ha.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Hi.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Fu.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_He.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Ho.class.getName()));
