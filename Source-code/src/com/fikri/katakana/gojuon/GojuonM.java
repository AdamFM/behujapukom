...
public class GojuonM extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(this, Kata_Ma.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Mi.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Mu.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Me.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Mo.class.getName()));
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        GojuonM.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator("MA")); 
        GojuonM.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab2").setIndicator("MI")); 
        GojuonM.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab3").setIndicator("MU"));
        GojuonM.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab4").setIndicator("ME")); 
        GojuonM.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab5").setIndicator("MO")); 
     ...
     * @param args
     */
    private static void AddTab(GojuonM activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
