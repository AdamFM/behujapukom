...
public class GojuonT extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPagerT() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Ta.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Chi.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Tu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Te.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_To.class.getName()));
	    ...
	    private void initialiseTabHostT(Bundle args) {
	    	...
	    	GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("TA"), ( tabInfo = new TabInfo("Tab6", Kata_Ka.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("CHI"), ( tabInfo = new TabInfo("Tab7", Kata_Ki.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("TSU"), ( tabInfo = new TabInfo("Tab8", Kata_Ku.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab9").setIndicator("TE"), ( tabInfo = new TabInfo("Tab9", Kata_Ke.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonT.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab10").setIndicator("TO"), ( tabInfo = new TabInfo("Tab10", Kata_Ko.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
