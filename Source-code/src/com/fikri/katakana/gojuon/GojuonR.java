...
public class GojuonR extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(this, Kata_Ra.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Ri.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Ru.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Re.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_Ro.class.getName()));
