...
public class Gojuon extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		btnVokal.setBackgroundColor(color);
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(this, Kata_a.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_i.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_u.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_e.class.getName()));
        fragments.add(Fragment.instantiate(this, Kata_o.class.getName()));
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        Gojuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator("A")); 
        Gojuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab2").setIndicator("I")); 
        Gojuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab3").setIndicator("U"));
        Gojuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab4").setIndicator("E")); 
        Gojuon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab5").setIndicator("O")); 
     ...
     * @param args
     */
    private static void AddTab(Gojuon activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
