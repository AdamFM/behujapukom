...
public class GojuonK extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  private TabHost mTabHost;
	  private ViewPager mViewPager;
	  private HashMap<String, TabInfo> mapTabInfo = new HashMap<String, GojuonK.TabInfo>();
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(GojuonK.this);
			...
			btnVokal.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent k = new Intent().setClass(getApplicationContext(), Gojuon.class);
	        ...
	        this.initialiseTabHostK(savedInstanceState);
	        if (savedInstanceState != null) {
	            mTabHost.setCurrentTabByTag(savedInstanceState.getString("tab")); //set the tab as per the saved state
	        }
	        // Intialise ViewPager
	        this.initialiseViewPagerk();        
	    }
	     ...
	     */
	    private void initialiseViewPagerk() {
	    	 List<Fragment> fragments = new Vector<Fragment>();
	       
	         fragments.add(Fragment.instantiate(this, Kata_Ka.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Ki.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Ku.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Ke.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Ko.class.getName()));
	     ...
	     */
	    private void initialiseTabHostK(Bundle args) {
	    	mTabHost = (TabHost)findViewById(android.R.id.tabhost);
	        mTabHost.setup();
	        TabInfo tabInfo = null;
	        
	    	GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("KA"), ( tabInfo = new TabInfo("Tab6", Kata_Ka.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("KI"), ( tabInfo = new TabInfo("Tab7", Kata_Ki.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("KU"), ( tabInfo = new TabInfo("Tab8", Kata_Ku.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab9").setIndicator("KE"), ( tabInfo = new TabInfo("Tab9", Kata_Ke.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	        GojuonK.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab10").setIndicator("KO"), ( tabInfo = new TabInfo("Tab10", Kata_Ko.class, args)));
	        this.mapTabInfo.put(tabInfo.tag, tabInfo);
	     ...
	     * @param args
	     */
	    private static void AddTab(GojuonK activity, TabHost tabHost, TabHost.TabSpec tabSpec, TabInfo tabInfo) {
