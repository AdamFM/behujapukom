...
public class YoonC extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.cha);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.chu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.cho);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonC.this);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Cha.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Chu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Cho.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonC.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("CHA"));
	        YoonC.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("CHU"));
	        YoonC.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("CHO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonC activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
