...
public class Yoon extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	        	...
	        	mediaPlayer = MediaPlayer.create(this, R.raw.kyu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.kyo);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(Yoon.this);
			...
			btnKy.setBackgroundColor(color);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Kya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Kyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Kyo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	Yoon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("KYA"));
	        Yoon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("KYU"));
	        Yoon.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("KYO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(Yoon activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
