...
public class YoonR extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.rya);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.ryu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.ryo);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonR.this);
			...
			btnRy.setBackgroundColor(color);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Rya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Ryu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Ryo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonR.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("RYA"));
	        YoonR.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("RYU"));
	        YoonR.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("RYO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonR activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
