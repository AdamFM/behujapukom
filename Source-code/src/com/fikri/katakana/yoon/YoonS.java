...
public class YoonS extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Sha.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Shu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Sho.class.getName()));
