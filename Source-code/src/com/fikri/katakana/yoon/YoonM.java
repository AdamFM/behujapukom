...
public class YoonM extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.mya);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.myu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.myo);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonM.this);
			...
			btnMy.setBackgroundColor(color);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Mya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Myu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Myo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonM.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("MYA"));
	        YoonM.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("MYU"));
	        YoonM.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("MYO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonM activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
