...
public class YoonN extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.nya);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.nyu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.nyo);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonN.this);
			...
			btnNy.setBackgroundColor(color);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Nya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Nyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Nyo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonN.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("NYA"));
	        YoonN.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("NYU"));
	        YoonN.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("NYO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonN activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
