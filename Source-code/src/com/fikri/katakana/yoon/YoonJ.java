...
public class YoonJ extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.ja);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.ju);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.jo);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonJ.this);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Jya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Jyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Jyo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonJ.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("JA"));
	        YoonJ.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("JU"));
	        YoonJ.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("JO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonJ activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
