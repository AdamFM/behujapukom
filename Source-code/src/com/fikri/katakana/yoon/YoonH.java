...
public class YoonH extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Hya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Hyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Hyo.class.getName()));
