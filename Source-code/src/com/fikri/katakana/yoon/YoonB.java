...
public class YoonB extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void playSound(int arg){
	        ...
	        if (arg == 0){
	            ...
	            mediaPlayer = MediaPlayer.create(this, R.raw.bya);
	        }
	        else if (arg == 1) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.byu);
	        }
	        else if (arg == 2) {
	        	mediaPlayer = MediaPlayer.create(this, R.raw.byo);
	        }
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        mDrawer = MenuDrawer.attach(YoonB.this);
			...
			btnBy.setBackgroundColor(color);
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Bya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Byu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Byo.class.getName()));
	    ...
	    private void initialiseTabHost(Bundle args) {
	    	...
	    	YoonB.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab6").setIndicator("BYA"));
	        YoonB.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab7").setIndicator("BYU"));
	        YoonB.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab8").setIndicator("BYO"));
	     ...
	     * @param args
	     */
	    private static void AddTab(YoonB activity, TabHost tabHost, TabHost.TabSpec tabSpec) {
