...
public class YoonG extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	  ...
	  private MediaPlayer mediaPlayer;
	    ...
	    private void initialiseViewPager() {
	         ...
	         fragments.add(Fragment.instantiate(this, Kata_Gya.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Gyu.class.getName()));
	         fragments.add(Fragment.instantiate(this, Kata_Gyo.class.getName()));
